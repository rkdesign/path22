...
class TCGAResource(Resource):
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='cohort', plugin='path22',
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='case', plugin='path22',
               level=AccessType.READ)
    @describeRoute(
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='slide', plugin='path22',
               level=AccessType.READ)
    @describeRoute(
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='image', plugin='path22',
               level=AccessType.READ)
    @describeRoute(
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='pathology', plugin='path22',
               level=AccessType.READ)
    @describeRoute(
    ...
    @access.public(scope=TokenScope.DATA_READ)
    @loadmodel(model='aperio', plugin='path22',
               level=AccessType.READ)
    @describeRoute(
