...
class Path22Resource(Resource):
    def __init__(self):
        super().__init__()
        self.resourceName = 'Path22'
        ...
        #   `/api/v1/path22/child_metadata/foobar`
        ...
        #  `GET /api/v1/path22/query_metadata`
        self.route('GET', ('query_metadata',), self.findItemsByMetadata)

    @describeRoute(
        Description('Get public settings for Path22.')
    )
    @access.public
